			...
			<div class="card">
                ...
                <form action="{{ route('secciones.actualizar', $seccion->id)}}" method="post">
					...
					<div class="form-group row">
						...
						<div class="col-sm-8">
                        <input class="form-control" type="text" id="nombre" name="nombre" required value="{{$seccion->nombre}}">
						</div>
                    </div>
                    <div class="form-group row">
						<label class="col-sm-4 col-form-label form-control-label">Hora Inicio</label>
						<div class="col-sm-8">
                        <input class="form-control" type="time" id="hora_inicio" name="hora_inicio" required value="{{$seccion->hora_inicio}}">
						</div>
                    </div>
                    <div class="form-group row">
						<label class="col-sm-4 col-form-label form-control-label">Hora Termino</label>
						<div class="col-sm-8">
                        <input class="form-control" type="time" id="hora_termino" name="hora_termino" required value="{{$seccion->hora_termino}}">
						</div>
					</div>
					<div class="form-group row">
