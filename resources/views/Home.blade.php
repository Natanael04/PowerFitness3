            ...
            <div class="container pr">
                ...
                <div class="row">
                    <div class="col-lg-4 col-lg-offset-4 col-md-4 col-md-offset-4 col-sm-4 col-sm-offset-4 col-xs-12">
                        <img src="images/metodos-pago.jpg" alt="Metodo de Pago PowerFitness" style="margin-top: 40px">
                        <p class="text-center" id="metodos-pago">Pago con efectivo, cheque o tarjetas.</p>
                    </div>
                </div>
            </div>
        </section>
